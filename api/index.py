...
rate_logs = {}       # Store IP request timestamps in memory

# ==== ENVIRONMENT VARIABLES ====
# ✅ Securely load from Vercel Environment (no keys in code)
...
app = FastAPI(
    ...
    description="Custom Fast API Wrapper for Social Downloader",
    version="1.0.0"
)
...
async def download(request: Request, url: str = None):
    ...
    encoded_url = httpx.utils.quote(url, safe="")
